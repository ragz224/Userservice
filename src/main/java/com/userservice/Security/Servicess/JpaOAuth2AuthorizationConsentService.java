package com.userservice.Security.Servicess;

import java.util.HashSet;
import java.util.Set;

import com.userservice.Security.Modelss.AuthorizationConsent;
import com.userservice.Security.Repositoriess.AuthorizationConsentRepository;
